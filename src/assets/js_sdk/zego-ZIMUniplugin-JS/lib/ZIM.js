...
export default class ZIM {
  ...
  constructor(engine) {
    if (!engine) throw new Error('Can not be use new.')
    this.engine = engine
  }
  /**
  ...
  deleteConversation(conversationID, conversationType, config) {
    return this.engine.deleteConversation(
      conversationID,
      conversationType,
      config
    )
  ...
  setConversationNotificationStatus(status, conversationID, conversationType) {
    return this.engine.setConversationNotificationStatus(
      status,
      conversationID,
      conversationType
    )
  ...
  clearConversationUnreadMessageCount(conversationID, conversationType) {
    return this.engine.clearConversationUnreadMessageCount(
      conversationID,
      conversationType
    )
  }
  ...
  sendMediaMessage(
    ...
    return this.engine.sendMediaMessage(
      message,
      toConversationID,
      conversationType,
      config,
  ...
  deleteMessages(messageList, conversationID, conversationType, config) {
    return this.engine.deleteMessages(
      messageList,
      conversationID,
      conversationType,
      config
  ...
  deleteAllMessage(conversationID, conversationType, config) {
    return this.engine.deleteAllMessage(
      conversationID,
      conversationType,
      config
    )
  ...
  queryHistoryMessage(conversationID, conversationType, config) {
    return this.engine.queryHistoryMessage(
      conversationID,
      conversationType,
      config
    )
