...
;(function (ZIMConnectionEvent) {
  ...
  ZIMConnectionEvent[(ZIMConnectionEvent['LoginInterrupted'] = 3)] =
    'LoginInterrupted'
...
;(function (ZIMMediaFileType) {
  ...
  ZIMMediaFileType[(ZIMMediaFileType['VideoFirstFrame'] = 4)] =
    'VideoFirstFrame'
...
;(function (ZIMRoomEvent) {
  ...
  ZIMRoomEvent[(ZIMRoomEvent['NetworkDisconnected'] = 2)] =
    'NetworkDisconnected'
...
;(function (ZIMRoomAttributesUpdateAction) {
  ZIMRoomAttributesUpdateAction[(ZIMRoomAttributesUpdateAction['Set'] = 0)] =
    'Set'
  ZIMRoomAttributesUpdateAction[(ZIMRoomAttributesUpdateAction['Delete'] = 1)] =
    'Delete'
...
;(function (ZIMGroupMessageNotificationStatus) {
  ...
  ZIMGroupMessageNotificationStatus[
    (ZIMGroupMessageNotificationStatus['Disturb'] = 2)
  ] = 'Disturb'
})(
...
;(function (ZIMGroupAttributesUpdateAction) {
  ZIMGroupAttributesUpdateAction[(ZIMGroupAttributesUpdateAction['Set'] = 0)] =
    'Set'
