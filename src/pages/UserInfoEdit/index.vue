<template>
  <view class="detailWrap">
    <uni-section title="个人形象展示" type="line">
...
.introduceWrap .introduceHead .edit {
  position: absolute;
  text-align: center;
  border-radius: 20px;
  top: 8rpx;
